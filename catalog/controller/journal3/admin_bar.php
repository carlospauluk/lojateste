...
class ControllerJournal3AdminBar extends Controller {
	...
	public function index() {
		...
		if (Str::startsWith($route, 'extension/') || Str::startsWith($route, 'api/') || Str::startsWith($route, 'feed/') || Str::startsWith($route, 'extension/')) {
			return;
		}

		\Journal3\Utils\Profiler::end('journal3/admin_bar');
